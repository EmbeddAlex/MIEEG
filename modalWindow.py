...
from PyQt5.QtCore import Qt, QPoint, QObject, pyqtSignal, QPropertyAnimation
from PyQt5.QtGui import QPainter, QPen, QPolygon, QBrush, QColor
from PyQt5.QtWidgets import QWidget, QDesktopWidget, \
    QPushButton, QApplication, QHBoxLayout, QVBoxLayout, QGraphicsColorizeEffect
...
class ShapesWidget(QWidget):
    ...
    def drawWidget(self, qp):
        qp.setPen(QPen(Qt.darkGreen, 3, Qt.SolidLine))
